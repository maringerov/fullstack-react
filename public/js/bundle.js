...
var AddCharacterActions = (function () {
  function AddCharacterActions() {
    ...
    this.generateActions('addCracterSuccess', 'addCharacterFail', 'updateName', 'updateGender', 'invalidName', 'invalidGender');
  }
  ...
  _createClass(AddCharacterActions, [{
    ...
    value: function addCharacter(name, gender) {
      ...
      $.ajax({
        ...
        _this.actions.addCracterSuccess(data.message);
      }).fail(function (jqXhr) {
...
var NavbarStore = (function () {
  ...
  _createClass(NavbarStore, [{
    ...
    key: 'onUpdateAjaxAnimationClass',
    value: function onUpdateAjaxAnimationClass(className) {
